...
export default function WithdrawScreen() {
    ...
    // Local state management for withdrawal amount and currency selection
    ...
    // Handle withdrawal confirmation with validation
    const handleConfirmWithdraw = async () => {
        ...
        try {
            ...
            setGeneralError("Withdrawal failed. Please try again.");
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <ModalContainer title="Withdraw" onClose={handleCancel}>
            <Text style={styles.subtitle}>Enter amount to withdraw</Text>
            ...
            {/* Confirm withdrawal button with validation */}
            <RoundedButton
                text={isLoading ? "Processing..." : "Confirm Withdrawal"}
